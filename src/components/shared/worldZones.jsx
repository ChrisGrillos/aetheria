...
export const ZONES = [
  ...
  },
  {
    ...
    danger: 3,
    color: "#1a2e1a",
    description: "Ancient trees block out the sun. Wolves and goblins lurk here.",
  ...
  },
  {
    ...
    danger: 4,
    color: "#3d3d3d",
    description: "Rich ore veins and treacherous paths. Trolls guard the deep mines.",
  ...
  },
  {
    ...
    danger: 5,
    color: "#2a3d1a",
    description: "Toxic vapors and undead haunt these murky waters.",
  ...
  },
  {
    ...
    danger: 1,
    color: "#4a5a20",
    description: "Fertile farmland stretching to the horizon. Bandits raid the farms.",
  ...
  },
  {
    ...
    danger: 7,
    color: "#5c1a00",
    description: "Scorched earth and rivers of lava. Dragons nest in the caldera.",
  ...
  },
  {
    ...
    danger: 4,
    color: "#4a5a6e",
    description: "Ancient ruins by the sea. Treasure hunters and sea monsters abound.",
